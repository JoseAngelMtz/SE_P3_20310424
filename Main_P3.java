...
public class Main_P3 extends JFrame implements ActionListener {
    ...
    public Main_P3(){
        ...
        setLayout(null);
        setTitle("Clue Region 4");
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        Titulo = new JLabel("Clue Region 4");
        Titulo.setBounds(250,0,450,50); //x, y, ancho, alto. Dentro del frame
...
//|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
        ImageIcon Fondo = new ImageIcon("morado.jpg");                                  //Imagen a cambiar
